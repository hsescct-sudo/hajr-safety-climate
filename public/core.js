window.Core = (() => {
  ...
  function migrateConfig(defaults, current){
    ...
    if(!c){ d.version=8; d.schema='hajr-safety-climate-v8'; return d; }
    if(c.project){
    ...
    // Preserve the verified five-role structure and all client edits from V7+.
    ...
    d.version=8; d.schema='hajr-safety-climate-v8';
    return d;
  }
  ...
  return {clone,esc,tx,canonicalRole,normalizedValue,pct,migrateConfig,roleObject,roleLabel,roleDescription,classify,LEGACY_ROLE_MAP};
})();
