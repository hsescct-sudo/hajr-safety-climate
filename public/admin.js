window.Admin = (() => {
  ...
  return {login,tab,refreshResponses,setDashboardDivision,setDashboardFactor,setDashboardSearch,clearDashboardFilters,openQuestionModal,closeQuestionModal,modalBackdrop,renderSettings,setProjectCode,setProjectText,setTheme,addLogo,replaceLogo,toggleLogo,deleteLogo,saveNow,renderQuestionBuilder,setQuestion,setQuestionText,addQuestion,moveQuestion,duplicateQuestion,deleteQuestion,addOpenQuestion,setOpen,deleteOpen,renderAudience,setLanguage,setRole,setRoleText,setDivisions,testStorage,resetResponses,exportConfig,exportJSON,exportCSV,changePin};
})();
